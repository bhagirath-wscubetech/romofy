        ...
        <div class="ftco-footer-widget mb-4">
          ...
          <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
            <li class="ftco-animate">
              <a target="_blank" href="<?php echo do_shortcode("[contact type='twitter']")?>">
                <span class="icon-twitter"></span>
              </a>
            </li>
            <li class="ftco-animate">
              <a target="_blank" href="<?php echo do_shortcode("[contact type='facebook']")?>">
                <span class="icon-facebook"></span>
              </a>
            </li>
            <li class="ftco-animate">
              <a target="_blank" href="<?php echo do_shortcode("[contact type='instagram']")?>">
            ...
            <ul>
              ...
              <li>
                <a href="#"><span class="icon icon-phone"></span>
                  <span class="text">
                    <?php echo do_shortcode(' [contact type="mobileno"]')?>
                  </span>
                </a>
              </li>
              <li>
                <a href="#"><span class="icon icon-envelope"></span>
                  <span class="text"><?php echo do_shortcode(' [contact type="email"]')?></span>
                </a>
              </li>
            </ul>
          </div>
...
<script src="<?php echo get_template_directory_uri()?>/product-shop.js"></script>
